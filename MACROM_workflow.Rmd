...
# ==============================================================================
K_min <- 20     # Minimum CDR carrying capacity (GtCO2/year)
K_max <- 300    # Maximum CDR carrying capacity (GtCO2/year)
n_K   <- 20     # Number of K values to test

# ==============================================================================
# USER CHOICE: CDR r range (growth rate)
# ==============================================================================
r_min       <- 0.01    # Minimum CDR growth rate
r_max       <- 0.50    # Maximum CDR growth rate
n_r         <- 10      # Number of r values to test
...
# ==============================================================================
g_initial <- 1      # Starting CDR deployment level (GtCO2/year)
...
# TO DO
# fix scale range for years over 1.5, since it can vary so dramatically depending on delays
...
cdr_scale_dashboard <- create_cdr_scale_temperature_dashboards(
